        ...
        <div id="aa" class="easyui-accordion" style="width:250px;height:300px;" data-options="fit:true,multiple:false">
            ...
            <div title="住宿管理" data-options="iconCls:'icon-reload'" style="padding:10px;">
                <ul class="easyui-tree">
                    <li><a class="opts" title="房间管理" url="/bike/tolist"><span style="display: block;width: 180px">房间管理</span></a></li>
                    <li><a class="opts" title="房间出租" url="/bike/tolist2"><span style="display: block;width: 180px">房间出租</span></a></li>
                    <%--<li><a class="opts" title="租赁信息展示" url="/pages/showdetail.jsp"><span style="display: block;width: 180px">租赁信息展示</span></a></li>--%>
                </ul>
            </div>
